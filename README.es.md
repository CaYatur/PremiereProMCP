...
**`PPMCP_PROFILE`** — `core` (~19) · `standard` (~109, por defecto) · `full` (277). PPMCP registra un **perfil**, no las 277 herramientas — el resto sigue accesible via `tool_search` → `tool_schema` → `tool_invoke`.
